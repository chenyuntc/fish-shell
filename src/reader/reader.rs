...
use crate::{
    ...
    copilot_autocomplete::copilot_autocomplete,
...
fn get_autosuggestion_performer(
    ...
    move || {
        ...
        if llm_mode {
            ...
            // The display layer expects the suggestion text to start with whatever
            // the user has already typed (search_string), then continue with the
            // new completion. Preserve trailing whitespace verbatim.
